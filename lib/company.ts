  ...
  cards: [
    {
      ...
      items: ["Выгода до 40% от цен на рынке РБ", "Полное таможенное оформление"],
    },
    {
...
export const BENEFITS = [
  {
    ...
    description:
      "Мы подбираем автомобили из США, учитывая предпочтения и требования клиентов. Наша команда отбирает качественные и надёжные автомобили с чистой историей и оптимальным соотношением цены и качества.",
  },
  {
    number: "02",
    title: "Профессиональная логистика",
    description:
      "Мы быстро и надёжно доставляем автомобили из США в Беларусь. Опытный логистический отдел минимизирует время и риски, гарантируя, что ваш автомобиль прибудет в сохранности и в срок.",
  },
  {
    number: "03",
    title: "Прозрачность и надёжность",
    description:
      "Мы ценим доверие клиентов и обеспечиваем прозрачность и надёжность во всех аспектах работы. Наша цель — комфорт и уверенность при покупке автомобиля из США. Мы предлагаем честные цены, чёткую информацию и профессиональное сопровождение на всех этапах сделки.",
  },
] as const;
...
export const TEAM: TeamMember[] = [
  ...
  { id: "sales-3", name: "Роман", role: "Менеджер по продажам" },
...
export const CAR_FINDER = {
  title: "Бесплатный подбор авто из США с выгодой до 40%",
  subtitle:
