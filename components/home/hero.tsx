...
export function Hero() {
  return (
    <section id="hero" className="relative min-h-[100svh] overflow-hidden pt-[calc(4rem+env(safe-area-inset-top))] md:min-h-[88vh]">
      <HeroBackdrop />
      ...
      <div className="relative mx-auto flex min-h-[calc(100svh-4rem-env(safe-area-inset-top))] max-w-7xl flex-col justify-end px-4 py-10 sm:justify-center sm:px-6 sm:py-16 md:min-h-[calc(88vh-4rem-env(safe-area-inset-top))] lg:px-8">
        ...
        <div className="grid grid-cols-2 gap-3 md:grid-cols-4 md:gap-6">
          <div className="card-premium reveal-on-scroll rounded-xl p-4 text-center md:p-6 md:text-left">
            <p className="font-display text-lg font-semibold text-accent-dark md:text-2xl">
              <CountUp prefix="до " value={40} suffix="%" />
            </p>
